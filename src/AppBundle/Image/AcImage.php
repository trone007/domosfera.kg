...
use AppBundle\Image\Geometry\Size;
use AppBundle\Image\Geometry\Point;
use AppBundle\Image\Geometry\Rectangle;
use AppBundle\Image\AcColor;
use AppBundle\Image\AcImageJPG;
use AppBundle\Image\AcImagePNG;
use AppBundle\Image\AcImageGIF;
...
class AcImage
{
	...
	protected function __construct($filePath)
	{
		...
		if (!is_array($imageInfo))
			throw new Exceptions\InvalidFileException($filePath);
	...
	public static function createImage($filePath)
	{
		...
		if (!self::isSupportedGD())
			throw new Exceptions\ GDnotInstalledException();
	...
	public function saveAsJPG($path)
	{
		...
		if(!imagejpeg(self::getResource(), $path, self::getQuality()))
			throw new Exceptions\ FileNotSaveException($path);
	...
	public function saveAsPNG($path)
	{
		if(!AcImagePNG::isSupport())
			throw new Exceptions\UnsupportedFormatException('png');
